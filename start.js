...
var gameTypeText = ["הדגמה - ללא צורך בקוד", "תרגול קצר", "תרגול ארוך", "טורניר - פרק טלוויזיוני"];

var gameStructure = ["פדיון - 12 ש' נבחרות, פ.השומה - 10ש', י.המס - 10ש'", "פדיון - 12 שאלות, פ.השומה - 20 ש', י.המס - 20 ש'", "פדיון - 24 שאלות, פ.השומה - 40 ש', י.המס - 40 ש'", "פדיון - 48 שאלות, פ.השומה - 40 ש', י.המס - 40 ש'"];
